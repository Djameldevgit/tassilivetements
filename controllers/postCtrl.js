...
const validatePostData = (postData) => {
    const requiredFields = ['title', 'category', 'subCategory', 'wilaya'];

    for (const field of requiredFields) {
        if (!postData || !postData[field] || postData[field].toString().trim() === '') {
...
const preparePostData = (postData, images) => {
    const preparedData = {
    ...
    if (postData.description) preparedData.description = postData.description;
    if (postData.price) preparedData.price = postData.price;
    if (postData.condition) preparedData.condition = postData.condition;
